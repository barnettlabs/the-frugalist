...
export const useAddWatchItem = createMutation<
  PriceTrackerItem,
  CreateWatchRequest,
  AxiosError
>({
...
export const useUpdateWatchItem = createMutation<
  PriceTrackerItem,
  UpdateWatchRequest,
  AxiosError
>({
...
export const useDeleteWatchItem = createMutation<
  void,
  DeleteWatchRequest,
  AxiosError
>({
...
export const useRefreshWatchItem = createMutation<
  PriceTrackerItem,
  RefreshWatchRequest,
  AxiosError
>({
