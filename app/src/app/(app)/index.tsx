...
import { FocusAwareStatusBar, Pressable, ScreenContainer, ScrollView, Text, View } from '@/components/ui';
import colors from '@/components/ui/colors';
import { Calculator as CalculatorIcon, Car as CarIcon, Tag as TagIcon } from '@/components/ui/icons';
  ...
  return (
    <ScreenContainer>
      ...
      >
        {/* Welcome Section */}
        <View className="mb-6">
          <Text className="text-4xl font-bold text-charcoal-900 dark:text-charcoal-50">Welcome Back</Text>
          <Text className="text-charcoal-500 dark:text-charcoal-400">
        ...
        <View className="mb-6 flex-row gap-3">
          <View className="flex-1 rounded-xl border border-charcoal-200/50 bg-white p-4 dark:border-charcoal-700/50 dark:bg-charcoal-900">
            <Text className="text-xs font-medium uppercase tracking-wide text-charcoal-500 dark:text-charcoal-400">
              Finance
            </Text>
            {isLoading ? (
          ...
          <View className="flex-1 rounded-xl border border-charcoal-200/50 bg-white p-4 dark:border-charcoal-700/50 dark:bg-charcoal-900">
            ...
            {isLoading ? (
              ...
              <Text className="text-3xl font-bold text-accent-teal">{data?.trackerCount ?? 0}</Text>
            )}
          </View>
        </View>

        {/* Quick Access */}
        <Text className="mb-3 text-lg font-semibold text-charcoal-900 dark:text-charcoal-100">Quick Access</Text>
        <View className="mb-6 gap-3">
          <Link href="/(app)/finance/create" asChild>
            <Pressable className="flex-row items-center rounded-xl border border-charcoal-200/50 bg-white p-4 active:bg-charcoal-50 dark:border-charcoal-700/50 dark:bg-charcoal-900 dark:active:bg-charcoal-800">
              ...
              <View className="flex-1">
                <Text className="font-semibold text-charcoal-900 dark:text-charcoal-100">New Finance Estimate</Text>
                <Text className="text-sm text-charcoal-500 dark:text-charcoal-400">
          ...
          <Link href="/(app)/lease/create" asChild>
            <Pressable className="flex-row items-center rounded-xl border border-charcoal-200/50 bg-white p-4 active:bg-charcoal-50 dark:border-charcoal-700/50 dark:bg-charcoal-900 dark:active:bg-charcoal-800">
              ...
              <View className="flex-1">
                <Text className="font-semibold text-charcoal-900 dark:text-charcoal-100">New Lease Estimate</Text>
                <Text className="text-sm text-charcoal-500 dark:text-charcoal-400">
          ...
          <Link href="/(app)/tracker/create" asChild>
            <Pressable className="flex-row items-center rounded-xl border border-charcoal-200/50 bg-white p-4 active:bg-charcoal-50 dark:border-charcoal-700/50 dark:bg-charcoal-900 dark:active:bg-charcoal-800">
              ...
              <View className="flex-1">
                <Text className="font-semibold text-charcoal-900 dark:text-charcoal-100">Track a Product</Text>
                <Text className="text-sm text-charcoal-500 dark:text-charcoal-400">Monitor prices and get alerts</Text>
              </View>
            </Pressable>
          </Link>
        </View>
        ...
        {/* Learning Center */}
        <Text className="mb-3 text-lg font-semibold text-charcoal-900 dark:text-charcoal-100">Learning Center</Text>
        <View className="gap-3">
          <Link href="/(app)/learning/financing" asChild>
            <Pressable className="rounded-xl bg-primary-600 p-4 active:bg-primary-700">
              <Text className="font-semibold text-white">Understanding Vehicle Financing</Text>
              <Text className="text-sm text-primary-100">Learn key terms and tips for financing a vehicle</Text>
            </Pressable>
          </Link>

          <Link href="/(app)/learning/leasing" asChild>
            <Pressable className="rounded-xl bg-secondary-600 p-4 active:bg-secondary-700">
              <Text className="font-semibold text-white">Understanding Vehicle Leasing</Text>
              <Text className="text-sm text-secondary-100">Learn key terms and tips for leasing a vehicle</Text>
            </Pressable>
          </Link>
        </View>
      </ScrollView>
