...
const inputTv = tv({
	slots: {
		...
		prefix: 'pl-4 pr-2 text-base font-medium text-neutral-500 dark:text-neutral-400',
		input: 'flex-1 py-3 pr-4 font-inter text-base font-medium leading-5 dark:text-white',
	},
	variants: {
		focused: {
			true: {
