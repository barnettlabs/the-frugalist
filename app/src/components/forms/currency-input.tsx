...
import { formatCurrency, parseOrZero } from '@/lib/calculators/formatters';
...
const inputTv = tv({
  slots: {
    ...
    inputContainer:
      'mt-0 flex-row items-center rounded-xl border-[0.5px] border-neutral-300 bg-neutral-100 dark:border-neutral-700 dark:bg-neutral-800',
    prefix:
      'pl-4 pr-2 text-base font-medium text-neutral-500 dark:text-neutral-400',
    input:
      'flex-1 py-3 pr-4 font-inter text-base font-medium leading-5 dark:text-white',
  },
  variants: {
    focused: {
      true: {
