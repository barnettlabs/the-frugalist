...
export function LeaseCard({ sheet }: LeaseCardProps) {
  ...
  return (
    <Link href={`/(app)/lease/${sheet.id}`} asChild>
      ...
      <Pressable className="rounded-xl border border-neutral-200/60 bg-white p-4 shadow-card dark:border-charcoal-700/60 dark:bg-charcoal-850/90">
        ...
        <View className="mb-3 flex-row items-start justify-between">
          <View className="flex-1">
            <Text className="font-rubik text-lg font-semibold text-neutral-900 dark:text-white">
              {sheet.sheet_name || 'Untitled Estimate'}
            </Text>
            <Text className="font-rubik text-sm text-neutral-500 dark:text-neutral-400">
          ...
          <View className="rounded-full bg-secondary-100 px-3 py-1 dark:bg-secondary-900/30">
            <Text className="font-rubik text-xs font-bold uppercase tracking-wide text-secondary-600 dark:text-secondary-300">
              Lease
            </Text>
          </View>
        </View>
        ...
        <View className="mb-3 rounded-lg bg-neutral-50 p-3 dark:bg-charcoal-800/60">
          ...
          <Text className="font-rubik text-2xl font-bold text-secondary-600 dark:text-secondary-400">
            {formatCurrencyWithSymbol(leasePayment)}
          </Text>
          <Text className="font-rubik text-xs text-neutral-500 dark:text-neutral-400">
        ...
        <View className="flex-row justify-between">
          <View>
            <Text className="font-rubik text-xs font-medium uppercase tracking-wide text-neutral-400 dark:text-neutral-500">
              MSRP
            </Text>
            <Text className="font-rubik font-medium text-neutral-700 dark:text-neutral-300">
