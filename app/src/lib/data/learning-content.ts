...
export const LEASE_TERMS: Term[] = [
  ...
  },
  {
    ...
    definition:
      'Any upfront payments that reduce the capitalized cost, including down payment, trade-in, and rebates.',
  },
  {
  ...
  },
  {
    term: 'Buyout Price',
    definition:
      'The price to purchase the vehicle at lease end, typically the residual value plus any remaining fees.',
  },
];
