...
const { data: vehicleFinanceSheets } = useFetch('/api/vehicleFinanceSheets')
const { data: vehicleLeaseSheets } = useFetch('/api/vehicleLeaseSheets')
...
const stats = computed(() => [
	{
		...
		value: vehicleFinanceSheets.value?.length ?? '-',
	},
	{
		label: 'total lease sheets',
		value: vehicleLeaseSheets.value?.length ?? '-',
	},
		...
		<div class="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
			...
			<div class="grid grid-cols-1 items-start gap-4 lg:grid-cols-3 lg:gap-8">
				...
				<div class="grid grid-cols-1 gap-4">
					<AnnouncementsCard condensed />
					<NearbyDealersCard condensed />
				</div>
			</div>
		</div>
	</main>
