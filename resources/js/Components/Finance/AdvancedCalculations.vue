        ...
        <div v-if="summary">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div class="bg-blue-50 p-4 rounded-lg">
                    ...
                    <div class="text-2xl font-bold text-blue-900">${{ formatCurrency(summary.monthlyPayment) }}</div>
                </div>
                <div class="bg-green-50 p-4 rounded-lg">
                    <div class="text-sm text-green-600 font-medium">Total Interest</div>
                    <div class="text-2xl font-bold text-green-900">${{ formatCurrency(summary.interestAmount) }}</div>
                </div>
            </div>
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="text-sm font-medium text-green-600">-${{ formatCurrency(data.discounts) }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-sm text-gray-600">Rebates</span>
                            <span class="text-sm font-medium text-green-600">-${{ formatCurrency(data.rebates) }}</span>
                        </div>
                        <div class="border-t pt-2">
                            <div class="flex justify-between">
                                <span class="text-sm font-medium text-gray-900">Purchase Price</span>
                                <span class="text-sm font-bold text-gray-900">${{ formatCurrency(summary.purchasePrice) }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="border-t pt-2">
                            <div class="flex justify-between">
                                ...
                                <span class="text-sm font-bold text-gray-900">${{ formatCurrency(summary.loanAmount) }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="text-sm font-medium text-red-600">${{ formatCurrency(summary.interestAmount) }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div v-if="hasExtraPayments" class="bg-green-50 p-4 rounded-lg">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="text-sm font-medium text-green-900">${{ formatCurrency(interestSaved) }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-sm text-green-700">Total Extra Payments</span>
                            <span class="text-sm font-medium text-green-900">${{ formatCurrency(totalExtraPayments) }}</span>
                        </div>
                    </div>
                </div>
            </div>
