    ...
    <div class="futuristic-card p-6">
        ...
        <div class="space-y-4">
            <div v-for="(payment, index) in extraPayments" :key="index" class="bg-gray-50 p-4 rounded-lg">
                ...
                <div class="mt-3 text-sm text-gray-600">
                    <div class="flex items-center space-x-4">
                        <span>Duration: {{ payment.startMonth || 1 }} - {{ payment.endMonth || payment.startMonth || 1 }} months</span>
                        <span>•</span>
            ...
            <div v-if="extraPayments.length === 0" class="text-center py-8 text-gray-500">
                ...
                <p class="text-xs text-gray-400">Add extra payments to reduce your loan term and save on interest</p>
            </div>
        </div>
...
const getTotalExtraForPayment = (payment) => {
