...
const vehicleFinanceSheets = ref([])
                        ...
                        <section aria-labelledby="finance-estimates-overview-title">
                            <ul class="grid grid-cols-1 gap-8 sm:grid-cols-2">
                                ...
                                <Link
                                    ...
                                    class="block"
                                >
                                    <div class="bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-12 text-center hover:border-gray-400 transition-colors shadow">
                                        <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 13h6m-3-3v6m5 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                        </svg>
                                        <h3 class="mt-2 text-sm font-medium text-gray-900">No finance estimates</h3>
                                        <p class="mt-1 text-sm text-gray-500">Get started by creating a new finance estimate.</p>
                                    </div>
                                </Link>
                                ...
                                <template v-else>
                                            ...
                                            <div class="p-6">
                                                ...
                                                <div class="mt-4 grid grid-cols-2 gap-4 text-sm">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="ml-2 font-medium">${{ sheet.down_payment || '0' }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <!-- Add new sheet -->
                                    <Link href="/estimates/financing/create" class="list-none">
                                        <div class="bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-12 text-center hover:border-gray-400 transition-colors shadow">
                                            <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                                            </svg>
                                            <h3 class="mt-2 text-sm font-medium text-gray-900">Create new estimate</h3>
                                            <p class="mt-1 text-sm text-gray-500">Add a new finance estimate.</p>
                                        </div>
                                    </Link>
                                </template>
                            </ul>
