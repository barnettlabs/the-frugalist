            ...
            <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p class="text-lg text-gray-600">
                                            Break traditional financing rules
                                            with advanced calculations and
                                            real-time rates
                                        </p>
                                    </div>
                                </div>
                                <div>
                                    <Link href="/estimates/financing/create">
                                        <button
                                            class="bg-primary hover:bg-primary-shade-1 px-6 py-3 rounded-xl font-medium text-white transition-all duration-150 hover:neon-glow flex items-center space-x-2"
                                        >
                ...
                >
                    <div class="grid grid-cols-1 gap-2 lg:col-span-2">
                        <section
                            aria-labelledby="finance-estimates-overview-title"
                        >
                            <div class="mb-6">
                                <h2
                                    class="text-2xl font-bold text-gray-900 mb-2"
                                >
                                    Your Finance Estimates
                                </h2>
                                <p class="text-gray-600">
                                    Manage your vehicle financing calculations
                            ...
                            <ul class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            No finance estimates yet
                                        </h3>
                                        <p class="text-gray-600 mb-6">
                                            Start your first vehicle financing
                                            calculation to outsmart dealers
                                        </p>
                                        <Link
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <div>
                                                    ...
                                                    >
                                                        ${{
                                                            sheet.down_payment?.toLocaleString() ||
                                                            "0"
                                                        }}
                                                    </div>
                                                </div>
                            ...
                            <div class="space-y-3">
                                <div class="flex items-start space-x-3">
                                    ...
                                    <p class="text-sm text-gray-600">
                                        Always negotiate the total price before
                                        discussing financing terms
                                    </p>
                                </div>
                                <div class="flex items-start space-x-3">
                                    <div
                                    ...
                                    ></div>
                                    <p class="text-sm text-gray-600">
                                        Compare multiple financing scenarios to
                                        find the best deal
                                    </p>
                                </div>
                                <div class="flex items-start space-x-3">
                                    ...
                                    ></div>
                                    <p class="text-sm text-gray-600">
                                        Know your credit score and get
                                        pre-approved before shopping
                                    </p>
                                </div>
                            </div>
                        </div>
