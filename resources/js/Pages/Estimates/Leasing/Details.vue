              ...
              <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                <div class="flex items-center space-x-6 mb-6 lg:mb-0">
                  ...
                  <div>
                    ...
                    <p v-else class="text-lg text-gray-600">Calculate vehicle leasing options</p>
                  </div>
                </div>
                <div class="flex space-x-3">
                  ...
                  <button
                    @click="submitForm"
                    :disabled="loading"
                    class="bg-secondary hover:bg-secondary-shade-1 text-white px-6 py-3 rounded-xl font-medium transition-all duration-150 disabled:opacity-50 flex items-center space-x-2"
                  >
                    <svg
                      v-if="loading"
