            ...
            <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                ...
                <div class="mb-8">
                    ...
                    >
                        ...
                        >
                            <div
                                class="absolute -top-4 -right-4 w-32 h-32 bg-secondary/5 rounded-full"
                            ></div>
                            <div
                                class="absolute bottom-0 -left-4 w-24 h-24 bg-secondary/10 rounded-full"
                            ></div>
                        </div>
                        ...
                        <div class="relative text-center lg:text-left">
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="p-4 rounded-2xl bg-gradient-to-br from-secondary/10 to-secondary/20"
                                    >
                                        <CurrencyDollarIcon
                                    ...
                                    <div>
                                        ...
                                        <p class="text-lg text-gray-600">
                                            Master the lease game with smart
                                            calculations and tax benefit
                                            optimization
                                        </p>
                                    </div>
                                </div>
                ...
                >
                    <div class="grid grid-cols-1 gap-2 lg:col-span-2">
                        <section
                            aria-labelledby="lease-estimates-overview-title"
                        >
                            <div class="mb-6">
                                <h2
                                ...
                                <p class="text-gray-600">
                                    Manage your vehicle leasing calculations and
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p class="text-gray-600 mb-6">
                                            Start your first vehicle leasing
                                            calculation to maximize your
                                            advantage
                                        </p>
                                        <Link href="/estimates/leasing/create">
                                            <button
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    <div
                                                        class="p-2 rounded-lg bg-secondary/10"
                                                    >
                                                        <CurrencyDollarIcon
                        ...
                        <div class="futuristic-card bg-white p-6 border border-gray-200 shadow-sm">
                            ...
                            <div class="space-y-3">
                                <div class="flex items-start space-x-3">
                                    <div
                                        class="w-2 h-2 bg-secondary rounded-full mt-2 flex-shrink-0"
                                    ></div>
                                    <p class="text-sm text-gray-600">
                                        Focus on the total cost, not just
                                        monthly payments
                                    </p>
                                </div>
                                <div class="flex items-start space-x-3">
                                    ...
                                    ></div>
                                    <p class="text-sm text-gray-600">
                                        Negotiate the capitalized cost (vehicle
                                        price) first
                                    </p>
                                </div>
                                <div class="flex items-start space-x-3">
                                    ...
                                    ></div>
                                    <p class="text-sm text-gray-600">
                                        Understand residual values and money
