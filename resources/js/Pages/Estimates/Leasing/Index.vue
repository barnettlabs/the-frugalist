                    ...
                    >
                      ...
                      <div class="flex items-start space-x-3 mb-3">
                        ...
                        <div class="flex-1 min-w-0">
                          <div class="flex items-start justify-between gap-2 mb-1">
                            <h3
                              class="text-base font-bold text-gray-900 group-hover:text-secondary transition-colors truncate"
                            >
                      ...
                      <div class="grid grid-cols-3 gap-2">
                        <Link :href="`/estimates/leasing/${sheet.id}/edit`">
                          <button
                            class="w-full bg-secondary hover:bg-secondary-shade-1 text-white px-2 py-2 rounded-lg text-xs font-medium transition-all duration-150 flex items-center justify-center space-x-1"
                          >
