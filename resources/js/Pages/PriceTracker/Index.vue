          ...
          <div v-for="product in trackedProducts" :key="product.id" class="futuristic-card p-6">
            ...
            <div class="flex space-x-2">
              <Link
                ...
                class="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-800 px-3 py-2 rounded-lg text-sm font-medium transition-colors flex items-center justify-center space-x-1"
              >
