...
const recentIncidents = ref<Incident[]>([
  {
    ...
    impact: 'Low',
    description:
      'Temporary increased response times during database pool optimization. All services restored to normal performance.',
  },
  {
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="flex items-center justify-between py-6">
            ...
            <div class="flex items-center space-x-4">
              ...
              <Link
                href="/register"
                class="bg-primary hover:bg-primary-shade-1 text-white px-4 py-2 rounded-lg font-medium transition-all"
              >
                Register
              </Link>
            </div>
      ...
      <main class="py-12" :class="{ '-mt-24': user }">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="futuristic-card p-8">
              <div class="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p class="text-gray-600">
                    System incidents and maintenance windows from the past 30 days
                  </p>
                </div>
              </div>
              ...
              <div class="space-y-4">
                <div
                  ...
                  :key="incident.title"
                  class="p-6 rounded-lg bg-gray-50 border border-gray-200"
                >
          ...
          <div class="text-center">
            <Link
              href="/"
              class="bg-primary hover:bg-primary-shade-1 text-white px-8 py-3 rounded-xl font-medium transition-all duration-150 hover:neon-glow"
            >
              ← Back to Home
            </Link>
          </div>
