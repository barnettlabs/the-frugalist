		...
		<section class="card overflow-hidden">
			...
			<div class="p-5 sm:p-6">
				<div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
					...
					<FormField v-model="form.fees" name="fees" label="Fees" type="currency" :error="errors.fees" />
					<FormField
					...
					/>
					<FormField v-model="form.rebates" name="rebates" label="Rebates" type="currency" :error="errors.rebates" />
					<FormField
