...
const openBugModal = () => {
  bugForm.value.page_url = window.location.href
  bugForm.value.metadata = {
...
const submitBugReport = async () => {
  bugForm.value.processing = true
  // TODO: Implement bug report submission via API
  setTimeout(() => {
    closeBugModal()
  }, 1000)
}
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul class="space-y-2 text-gray-600">
              ...
              <li>
                <RouterLink to="/learning/financing" class="hover:text-primary transition-colors">
              ...
              <li>
                <RouterLink to="/learning/leasing" class="hover:text-primary transition-colors">
                  Learn About Leasing
                </RouterLink>
              </li>
              <li>
