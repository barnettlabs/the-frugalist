...
const supportedRetailers = ['Best Buy'];
	...
	<div class="min-h-screen relative">
		...
		<nav class="relative z-30 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-6 pb-2">
			<div class="flex items-center justify-between">
				<RouterLink to="/" class="flex items-center gap-2.5">
					...
					<span class="font-display text-2xl text-primary tracking-tightest"> thefrugalist </span>
				</RouterLink>
				<div class="flex items-center gap-2 sm:gap-5">
					...
					<template v-else>
						<RouterLink
							to="/login"
							class="hidden sm:inline-flex text-sm font-medium text-text-muted hover:text-primary transition-colors px-2 py-2"
						>
							Sign in
						</RouterLink>
						<RouterLink
		...
		<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-3">
			<div class="flex flex-wrap items-baseline gap-x-6 gap-y-2 py-2">
				...
				<template v-for="(retailer, i) in supportedRetailers" :key="retailer">
					...
					<span v-if="i < supportedRetailers.length - 1" class="text-border-strong font-mono text-sm" aria-hidden="true"
						>/</span
					>
				</template>
		...
		<section class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-10 sm:pt-14 lg:pt-20 pb-16 lg:pb-24">
			<div class="grid grid-cols-12 gap-6 lg:gap-12 items-center">
				...
				<div class="col-span-12 lg:col-span-7">
					...
					<h1
						class="font-display font-medium text-primary tracking-tightest leading-[0.92] text-[2.75rem] sm:text-6xl lg:text-[5.5rem] fade-up fade-up-1"
					>
						Spend with
					...
					<p class="mt-8 text-base sm:text-lg text-primary-light max-w-xl leading-relaxed fade-up fade-up-2">
						TheFrugalist is a calm tool for noisy markets. Track prices that move, run the numbers behind any financing
						offer, and learn the playbook dealers don&rsquo;t want you reading.
					</p>
				...
				<div class="col-span-12 lg:col-span-5 fade-up fade-up-2">
					<div class="relative">
						...
						<!-- Main card -->
						<div
							class="relative surface-navy paper-grain rounded-md border border-primary/30 overflow-hidden shadow-paper"
						>
							<!-- Top metadata strip -->
		...
		<section class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
			<div class="flex items-end justify-between mb-12 lg:mb-14">
				<div>
					...
					<h2
						class="font-display font-medium text-primary tracking-tightest text-4xl sm:text-5xl lg:text-6xl leading-[0.95] max-w-2xl"
					>
			...
			<div
				class="grid grid-cols-1 md:grid-cols-3 gap-px bg-border-strong border border-border-strong rounded-md overflow-hidden"
			>
				<RouterLink
				...
				>
					<div class="flex items-start justify-between mb-8">
						...
						<component
							:is="pillar.icon"
							class="h-5 w-5 text-text-muted group-hover:text-accent-dark transition-colors"
						/>
					</div>
			...
			<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
				<div class="grid grid-cols-12 gap-6 lg:gap-12 items-start">
					...
					<div class="col-span-12 lg:col-span-8 lg:border-l border-border lg:pl-12">
						<blockquote
							class="font-display italic text-primary tracking-tight text-3xl sm:text-4xl lg:text-5xl leading-[1.05]"
						>
							&ldquo;Urgency, anchoring, hidden add-ons, and pre-printed terms exist to make you decide
							<span class="text-accent-dark">faster</span> than your math can keep up. Slowing down is the entire
							move.&rdquo;
						</blockquote>
		...
		<section class="relative">
			<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
				<div
					class="surface-ink paper-grain rounded-md border border-primary-dark/40 px-6 py-12 sm:p-14 relative overflow-hidden"
				>
		...
		<footer class="border-t border-border-strong">
			<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
				<div class="grid grid-cols-12 gap-6 items-start">
					...
					<div class="col-span-6 sm:col-span-3">
						...
						<ul class="space-y-1.5 text-sm">
							<li>
								<RouterLink to="/watch" class="text-primary hover:text-accent-dark transition-colors">Watch</RouterLink>
							</li>
							<li>
								<RouterLink to="/estimates" class="text-primary hover:text-accent-dark transition-colors"
									>Compute</RouterLink
								>
							</li>
							<li>
								<RouterLink to="/learning" class="text-primary hover:text-accent-dark transition-colors"
									>Guides</RouterLink
								>
							</li>
						</ul>
					...
					<div class="col-span-6 sm:col-span-2">
						...
						<ul class="space-y-1.5 text-sm">
							<li>
								<RouterLink to="/privacy" class="text-primary hover:text-accent-dark transition-colors"
									>Privacy</RouterLink
								>
							</li>
							<li>
								<RouterLink to="/terms" class="text-primary hover:text-accent-dark transition-colors">Terms</RouterLink>
							</li>
						</ul>
					</div>
				...
				<div
					class="mt-10 pt-5 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-text-muted"
				>
