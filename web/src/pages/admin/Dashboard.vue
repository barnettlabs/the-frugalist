...
import { adminAnnouncementsApi, adminBugReportsApi, adminRetailersApi, adminUsersApi } from '@/api/admin';
...
<template>
	<div class="max-w-6xl mx-auto">
		<header class="mb-10">
			...
			<h1 class="font-display font-medium text-primary tracking-tight text-3xl sm:text-4xl mt-2">Manage the system.</h1>
