...
import { adminUsersApi, type AdminUser, type PaginatedUsers } from '@/api/admin'
  ...
  <div class="max-w-6xl mx-auto">
    ...
    <div v-else-if="result" class="card overflow-hidden">
      <table class="w-full text-sm">
        ...
        <tbody>
          <tr v-for="u in result.data" :key="u.id" class="border-t border-border hover:bg-surface-dark/30 transition-colors">
            <td class="px-4 py-3">
