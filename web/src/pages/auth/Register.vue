...
<template>
	<div>
		...
		<form class="space-y-5" @submit="submit">
			...
			<div>
				<InputLabel for="password_confirmation" value="Confirm Password" class="text-primary font-medium" />
				<TextInput
			...
			<div class="text-center pt-4 border-t border-border">
				<p class="text-sm text-text-muted">
					...
					<RouterLink to="/login" class="text-accent hover:text-accent-dark font-medium transition-colors">
						Sign in
					</RouterLink>
				</p>
			</div>
