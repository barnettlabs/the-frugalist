...
const loadSheets = async () => {
  ...
  try {
    const loadedSheets = await Promise.all(
      sheetIds.map((id) => financeApi.get(id))
    )
    ...
    <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
      ...
      <div class="mb-8">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-3xl font-bold text-gray-900">Compare Finance Estimates</h1>
            <p class="mt-2 text-gray-600">Side-by-side comparison of your financing options</p>
          </div>
            ...
            <tbody class="divide-y divide-gray-200">
              ...
              <tr>
                ...
                <td
                  v-for="sheet in sheets"
                  :key="sheet.id"
                  class="px-6 py-4 text-sm font-medium text-red-600"
                >
