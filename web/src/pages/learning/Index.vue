...
const whyLearn = [
	{ icon: ShieldCheckIcon, title: 'Recognize tactics', description: 'Spot the urgency theater the moment it begins.' },
	{
		...
		description: 'Terms, jargon, abbreviations, and what they actually mean.',
	},
	{
		icon: ExclamationTriangleIcon,
		title: 'Avoid the pitfalls',
		description: 'Hidden fees, unfavorable clauses, flagged in advance.',
	},
];
</script>
	...
	<div class="pb-16">
		...
		<section class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
			<div class="grid grid-cols-1 md:grid-cols-3 gap-px bg-border border border-border rounded-md overflow-hidden">
				<div v-for="(item, i) in whyLearn" :key="item.title" class="bg-surface p-6 flex items-start gap-4">
			...
			<div class="mt-12 lg:mt-16 grid grid-cols-12 gap-6 lg:gap-12 items-start border-t border-border pt-12">
				...
				<div class="col-span-12 lg:col-span-8 lg:border-l border-border lg:pl-12">
					<blockquote class="font-display italic text-primary tracking-tight text-2xl sm:text-3xl leading-snug">
						&ldquo;Read both guides. Understanding both financing
						<em class="not-italic text-accent-dark">and</em> leasing is what gives you leverage. It&rsquo;s how you
						recognize the moment a salesperson is steering you toward the path that pays them more.&rdquo;
					</blockquote>
				</div>
			</div>
		</section>
