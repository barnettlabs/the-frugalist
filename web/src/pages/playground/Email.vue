...
import { playgroundApi, type EmailTemplate } from '@/api/playground'
      ...
      <template v-else>
        ...
        <Card class="mb-6">
          ...
          <div class="mt-6 flex flex-wrap gap-3">
            <PrimaryButton @click="previewEmail" :disabled="!selectedTemplate || loading" class="gap-2">
              <Spinner v-if="loading" size="sm" color="gray" />
              <EyeIcon v-else class="h-4 w-4" />
              Preview Email
            </PrimaryButton>

            <SecondaryButton @click="sendTestEmail" :disabled="!selectedTemplate || sendingEmail" class="gap-2">
