...
export default {
	...
	safelist: [
		...
		{
			pattern:
				/text-(primary|primary-light|primary-dark|accent|accent-light|accent-dark|secondary|secondary-light|secondary-dark|signal|signal-light|signal-dark|success|info|warning|danger|light|dark|text-muted|text-primary)/,
			variants: ['hover', 'focus', 'active'],
		},
		{
			pattern:
				/border-(primary|primary-light|primary-dark|accent|accent-light|accent-dark|secondary|secondary-light|secondary-dark|signal|success|info|warning|danger|light|dark|border|border-strong)/,
			variants: ['hover', 'focus', 'active'],
		},
		{
